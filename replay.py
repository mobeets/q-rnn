    ...
    def sample(self):
        ...
        if self.random_update: # Random update
            if len(self.memory) < self.batch_size:
                sampled_episodes = random.choices(self.memory, self.batch_size) # sample with replacement
            else:
                sampled_episodes = random.sample(self.memory, self.batch_size) # sample without replacement
